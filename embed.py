...
def build(input_path: str, output_path: str, show_fps: bool, scale: int, static: bool, windows: bool):
    ...
    cmake_command.extend([f'-DG1_FLAG_SHOW_FPS={show_fps}', f'-DG1_FLAG_SCALE={scale}'])
...
def main():
    ...
    try:
        build(args.input_path, args.output_path, args.show_fps, args.scale, args.static, args.windows)
